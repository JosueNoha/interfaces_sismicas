#!/usr/bin/env python3
"""
Script para construir el ejecutable de la aplicación Perú
"""
...
def clean_build_dirs():
    ...
    dirs_to_clean = ['build', 'dist/peru', '__pycache__']
...
def build_peru():
    """Construye el ejecutable de Perú usando PyInstaller"""
    print("=" * 60)
    print("CONSTRUYENDO APLICACIÓN ANÁLISIS SÍSMICO - PERÚ")
    print("=" * 60)
    
    # Verificar que estamos en el directorio correcto
    project_root = Path().resolve()
    spec_file = project_root / 'build_scripts' / 'peru.spec'
    ...
    try:
        ...
        print("✅ BUILD EXITOSO")
        print(f"Ejecutable generado en: {project_root / 'dist' / 'AnalisisSismicoPeru'}")
        
        # Verificar que el ejecutable se creó
        exe_path = project_root / 'dist' / 'AnalisisSismicoPeru' / 'AnalisisSismicoPeru.exe'
        if exe_path.exists():
