...
peru_app_path = project_root / 'apps' / 'peru' / 'main_peru.py'
...
a = Analysis(
    ...
    datas=[
        ...
        # Recursos específicos de Perú
        (str(project_root / 'apps' / 'peru' / 'resources'), 'apps/peru/resources'),
        # Icono compartido
